...
addressRouter.patch("/:id", userTokenVerificationMiddleware, dataVerificationByYupMiddlewares(updateAddressSchema), addressUpdateController )

//DELETAR ENDEREÇO
addressRouter.delete("/:id",userTokenVerificationMiddleware, checkingIfYouAreTheAuthorizedUserOrEmployeeMiddleware, deleteAddressController)
